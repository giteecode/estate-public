...
@Controller
@RequestMapping("/admin/visit_info")
public class AVisitInfoController {
    ...
    */
    ...
    public String update3(ModelMap modelMap, VisitInfo model, HttpServletRequest request) {
        ...
        return "admin/visit_info/update3_page";
    }
    ...
    */
    ...
    @ResponseBody
    public Object update3_submit(VisitInfo model, ModelMap modelMap,HttpServletRequest request) {
        LoginModel login = (LoginModel) request.getSession().getAttribute(CommonVal.sessionName);
        Map<String, Object> rs = new HashMap<String, Object>();
        String msg = visitInfoService.update3(model, login); //执行修改操作
