...
@Controller
@RequestMapping("/admin/car_info")
public class ACarInfoController {
    ...
    */
    ...
    @ResponseBody
    public Object toList(CarInfo model, Integer page,
                         HttpServletRequest request) {
        LoginModel login = (LoginModel) request.getSession()
                                               .getAttribute(CommonVal.sessionName);

        return carInfoService.getDataList(model, page, CommonVal.pageSize,
            login); //分页查询数据
    }
    ...
    */
    ...
    public String add(ModelMap modelMap, CarInfo model,
        ...
        return "admin/car_info/add_page";
    }
    ...
    */
    ...
    public String update(ModelMap modelMap, CarInfo model,
        ...
        return "admin/car_info/update_page";
    }
