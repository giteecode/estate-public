...
@Controller
@RequestMapping("/user/repair_info")
public class URepairInfoController {
    ...
    */
    ...
    public String index(ModelMap modelMap, HttpServletRequest request) {
        ...
        return "user/repair_info/list";
    }

    /**
     * 根据查询条件分页查询报修数据,然后返回给前台渲染
    */
    @RequestMapping(value = "queryList")
    @ResponseBody
    public Object toList(RepairInfo model, Integer page,HttpServletRequest request) {
        LoginModel login = (LoginModel) request.getSession().getAttribute(CommonVal.sessionName);
        model.setUserId(login.getId()); //报修用户等于当前登录id
    ...
    */
    ...
    @ResponseBody
    public Object add_submit(RepairInfo model, ModelMap modelMap,HttpServletRequest request) {
        LoginModel login = (LoginModel) request.getSession().getAttribute(CommonVal.sessionName);
        Map<String, Object> rs = new HashMap<String, Object>();
        String msg = repairInfoService.add(model, login); //执行添加操作
    ...
    */
    ...
    public String update(ModelMap modelMap, RepairInfo model,HttpServletRequest request) {
        LoginModel login = (LoginModel) request.getSession().getAttribute(CommonVal.sessionName); //从session中获取当前登录账号
        getList(modelMap, login); //获取前台需要用到的数据列表并返回给前台
        ...
        return "user/repair_info/update_page";
    }
    ...
    */
    ...
    @ResponseBody
    public Object update_submit(RepairInfo model, ModelMap modelMap,HttpServletRequest request) {
        LoginModel login = (LoginModel) request.getSession().getAttribute(CommonVal.sessionName);
        Map<String, Object> rs = new HashMap<String, Object>();
        String msg = repairInfoService.update(model, login); //执行修改操作
