...
public class AdminInfoServiceImpl implements AdminInfoService {
    ...
    */
    @Override
    public Map<String, Object> getDataList(AdminInfo queryModel, Integer page, Integer pageSize, LoginModel login) {
    ...
    */
    @Override
    public Map<String, Object> getAdminInfoModel(AdminInfo model,LoginModel login) {
