...
public class UserInfoServiceImpl implements UserInfoService {
    ...
    */
    ...
    public String update(UserInfo model, LoginModel login) {
        ...
        if(model.getWyFee() !=null && !"".equals(model.getWyFee())){
            preModel.setWyFee(model.getWyFee());

        }
        preModel.setCar(model.getCar());
    ...
    */
    @Override
    public Map<String, Object> getDataList(String nameOrder,UserInfo queryModel, Integer page, Integer pageSize, LoginModel login) {
