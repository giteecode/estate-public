...
public interface ComplainInfoService {
    /**
      分页查询投诉数据列表
    */
    public Map<String, Object> getDataList(ComplainInfo queryModel,Integer page, Integer pageSize, LoginModel login);

    /**
      封装投诉为前台展示的数据形式
    */
    public Map<String, Object> getComplainInfoModel(ComplainInfo model,LoginModel login);
