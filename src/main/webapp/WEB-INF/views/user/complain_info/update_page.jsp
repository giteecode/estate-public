<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <![endif]-->
            ...
            <body>
                ...
                <div class="page-container">
                    ...
                    <div class="row cl" id="complainContentParentContent" style="margin-top:20px;margin-left:20px;">
                        ...
                        <div class="formControls col-xs-8 col-sm-9">
                            <textarea placeholder="请输入投诉内容" id="complainContent" rows="15"
                                cols="100">${data.complainContent}</textarea>
                        </div>
                    </div>
                ...
                <!--/_footer /作为公共模版分离出去-->
                <script type="text/javascript"
                    src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=6967"></script>
