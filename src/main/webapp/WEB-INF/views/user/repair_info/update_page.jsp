<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <![endif]-->
            ...
            <body>
                ...
                <div class="page-container">
                    ...
                    <div class="row cl" id="repairContentParentContent" style="margin-top:20px;margin-left:20px;">
                        ...
                        <div class="formControls col-xs-8 col-sm-9">
                            <textarea placeholder="请输入报修内容" id="repairContent" rows="15"
                                cols="100">${data.repairContent}</textarea>
                        </div>
                    </div>
                ...
                <!--/_footer /作为公共模版分离出去-->
                <script type="text/javascript"
                    src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=3544"></script>
                ...
                <script type="text/javascript">
                    ...
                    function submitData() {
                        ...
                        $.ajax({
                            type: 'post',
                            url: '${pageContext.request.contextPath}/user/repair_info/update_submit',
                            data: {
                                "id": '${data.id}',
