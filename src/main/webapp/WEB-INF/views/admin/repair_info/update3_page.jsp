            ...
            <body>
                ...
                <div class="page-container">
                    ...
                    <div class="row cl" id="replyContentParentContent" style="margin-top:20px;margin-left:20px;">
                        ...
                        <div class="formControls col-xs-8 col-sm-9">
                            <textarea placeholder="请输入回复内容" id="replyContent" rows="15"
                                cols="100">${data.replyContent}</textarea>
                        </div>
                    </div>
                ...
                <script type="text/javascript">
                    ...
                    function submitData() {
                        ...
                        $.ajax({
                            type: 'post',
                            url: '${pageContext.request.contextPath}/admin/repair_info/update3_submit',
                            data: {
                                "id": '${data.id}',
