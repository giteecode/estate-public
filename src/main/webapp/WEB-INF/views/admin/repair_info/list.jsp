            ...
            <body>
                ...
                <script type="text/javascript">
                    ...
                    function ajaxList(page) {
                        ...
                        $.ajax({
                            type: 'get',
                            url: "${pageContext.request.contextPath}/admin/repair_info/queryList",
                            data: {
                                "page": page,
                            ...
                            success: function (result) {
                                ...
                                for (var i = 0; i < rows.length; i++) {
                                    ...
                                    html += '<td>';
                                    if (rows[i].repairInfo.isDeal == '1') {
                                        html += '<a href="${pageContext.request.contextPath}/admin/repair_info/update3?id=' + rows[i].repairInfo.id + '" class="btn btn-primary  radius btnStyle">处理</a>';
                                    }
                                    html += '</td>';
                                    html += '</tr>';
                                }
