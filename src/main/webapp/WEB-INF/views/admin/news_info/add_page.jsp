    ...
    <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
        ...
        <script type="text/javascript" src="${pageContext.request.contextPath}/static/hui/lib/html5shiv.js"></script>
            ...
            <body>
                ...
                <div class="page-container">
                    ...
                    <div class="row cl" id="titleParentContent" style="margin-top:20px;margin-left:20px;">
                        ...
                        <div class="formControls col-xs-8 col-sm-9">
                            <input type="text" class="input-text" style="width:500px;display:inline" placeholder="请输入标题"
                                id="title">
                        </div>
                    </div>
                ...
                <!--/_footer /作为公共模版分离出去-->
                <script type="text/javascript"
                    src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=1645"></script>
